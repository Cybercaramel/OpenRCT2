...
rct_window *window_ride_construction_open()
{
	...
	RCT2_GLOBAL(0x00F44070, uint32) = MONEY32_UNDEFINED;
...
static void window_ride_construction_paint()
{
	...
	string_y += 11;
	if (RCT2_GLOBAL(0x00F44070, uint32_t) != MONEY32_UNDEFINED && !(RCT2_GLOBAL(RCT2_ADDRESS_PARK_FLAGS, uint32_t) & 0x800))
